...
information and pushes it up to Redis with status:node:x hash key. <status_node>
"""
import time
import struct
...
def status_node(data, addr):
    data_dict = {}
    if data is None or addr is None:  # Return empty dict to get keys.
        mac_str, addr, node = None, [None], None
        unpacked_nodeID_metadata = None
        unpacked_mcptemp_top, unpacked_mcptemp_mid, unpacked_mcptemp_bot = None, None, None
        unpacked_htutemp, unpacked_htuhumid, unpacked_snap_relay = None, None, None
        unpacked_fem, unpacked_pam, unpacked_cpu_uptime = None, None, None
        unpacked_snapv2_0, unpacked_snapv2_1 = None, None
        unpacked_snapv2_2, unpacked_snapv2_3 = None, None
    else:
