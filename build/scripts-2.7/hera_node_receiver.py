...
try:
    while True:
        ...
        unpacked_snapv2_0 = struct.unpack('=?',data[23])
        unpacked_snapv2_1 = struct.unpack('=?',data[24])
        unpacked_snapv2_2 = struct.unpack('=?',data[25])
        unpacked_snapv2_3 = struct.unpack('=?',data[26])
        ...
        unpacked_nodeID = struct.unpack('=B',data[33])
        unpacked_nodeID_metadata = struct.unpack('=B',data[34])
